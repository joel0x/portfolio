      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <ServiceCard
            ...
            description="Serverless GPU endpoints on RunPod. Docker containers, REST APIs, and async queues that scale without breaking your budget."
            number="01"
            delay={0}
          />
          <ServiceCard
            ...
            description="LipSync for multi-language dubbing. Character-consistent video generation with LTX and Wan. Bulk automation to process thousands of assets."
            number="02"
            delay={100}
          />
          <ServiceCard
